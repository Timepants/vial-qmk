...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x5(
        ...
        KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                                        KC_N  , KC_M  ,KC_COMM, KC_DOT,KC_SLSH,
                KC_LALT,KC_DEL,                                                                       KC_QUOT, KC_EQL,
                                KC_LCTL, KC_ESC,                                        KC_LSFT,KC_LCTL,
                                                KC_SPC , KC_TAB,      KC_BSPC, KC_SPC,
                                                KC_LGUI, RAISE ,      LOWER  , KC_ENT
    ),
    ...
    [_RAISE] = LAYOUT_5x5(
          ...
          KC_F11, KC_F12,_______,_______,KC_LBRC,                                     KC_RBRC,_______,KC_NUM,KC_INS ,KC_SCRL,
